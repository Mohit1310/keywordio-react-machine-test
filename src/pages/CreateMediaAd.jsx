  ...
  return (
    <div className="border m-7">
      ...
      <form className="p-3" onSubmit={handleSubmit}>
        <div className="block md:grid grid-flow-col gap-7">
        ...
        <div className="flex flex-col md:grid md:grid-flow-col gap-6 mt-4">
          <div className="flex flex-col gap-2">
            <label htmlFor="landscapeMarketing">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="potraitMarketing">
